              ...
              return (
                <View style={{backgroundColor: '#fff', width: '98%'}} key={item.title}>
                  <Flex>
                    ...
                    <Text style={{flex: 1, textAlign: 'right', color: '#585858', paddingRight: 16, lineHeight: 32, fontSize: 14}} ellipsizeMode={'tail'} numberOfLines={1}>{item.formatter ? item.formatter(detailInfo[item.key], detailInfo) : detailInfo[item.key]}</Text>
                  </Flex>
