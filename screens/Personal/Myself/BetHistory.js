    ...
    return (
      <TouchableHighlight onPress={() => this.props.onPressFunc(item)}>
        <View style={{padding: 10, backgroundColor: '#fff', position: 'relative'}}>
          ...
          <Text style={{color: '#666', fontSize: 14, lineHeight: 22}} note ellipsizeMode={'tail'} numberOfLines={1}>投注号码: <Text style={{color: '#1689e6'}}>{rulesNameMap[castCodes] || castCodes}</Text></Text>
