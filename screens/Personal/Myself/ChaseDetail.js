  ...
  constructor(props) {
    ...
    this.state = {
      keyList: [
        ...
        {key: 'haltAdditionName', title: '中将即停'},
    ...
    queryOrderAdditions({userId: props.loginInfo.acc.user.userId, batchNo: props.navigation.getParam('detail', {}).batchNo}).then(res => {
      if (res.code === 0) {
